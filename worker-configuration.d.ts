/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f43291720be2a02e10431b9d8232717a)
// Runtime types generated with workerd@1.20260305.0 2026-01-26 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface ProductionEnv {
		BETTER_AUTH_ALLOWED_HOSTS: "caldav.gigun-dev.workers.dev,*-caldav.gigun-dev.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_ALLOWED_HOSTS" | "BETTER_AUTH_PRODUCTION_URL" | "CLOUDFLARED_TOKEN" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "SERVER_URL">> {}
}
